...
class TreeNumpy(object):
    ...
    def vector(self, varName, lenvar, maxlen=None, type=float, default=-99, title=None, storageType="default", filler=None ):
        ...
        """Either lenvar is a string, and maxlen an int (variable size
        array), or lenvar is an int and maxlen is not specified (fixed
        array)."""
    ...
    def vFillWithIndex(self, varName, index, value):

        """Fill specified variable/fixed array at location @index with
        value @value"""
